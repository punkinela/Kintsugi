...
import {
  ...
  HelpCircle, Settings, Sparkles, Zap, Trophy, Shield, Heart, Volume2
} from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        {activeTab === 'settings' && (
          <div className="space-y-6">
            ...
            {/* Voice Profile Manager - AI Feature */}
            <div className="bg-white dark:bg-kintsugi-dark-800 rounded-2xl shadow-lg border-2 border-gray-200 dark:border-gray-700 p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
                Teaching AI to write in your authentic voice, not generic ChatGPT style. Add writing samples to personalize all AI-generated content.
              </p>
