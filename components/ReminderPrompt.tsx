      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
        ...
        >
          ...
          <div className="space-y-6">
            {/* Enable Toggle */}
            <div className="flex items-center justify-between p-4 theme-bg-primary-light/50 dark:bg-kintsugi-gold-900/10 rounded-xl border border-kintsugi-gold-100 dark:theme-border-primary/30">
              <div>
              ...
              <button
                ...
                className={`relative w-14 h-8 rounded-full transition-colors ${
                  enabled ? 'theme-bg-primary' : 'bg-kintsugi-gold-200 dark:bg-kintsugi-gold-800/50'
                }`}
              >
                <motion.div
            ...
            {enabled && (
              ...
              >
                ...
                <div className="flex items-center gap-3 p-4 theme-bg-primary-light/50 dark:bg-kintsugi-gold-900/10 rounded-xl border border-kintsugi-gold-100 dark:theme-border-primary/30">
            ...
            {/* Info Box */}
            <div className="theme-bg-primary-light/50 dark:bg-kintsugi-gold-900/10 border theme-border-light dark:theme-border-primary/30 rounded-xl p-4">
